...
<!-- FIN DE JAVASCRIPT -->
<body>
<section id="home" style="padding:110px 0;background-image: url(imag/backgroundad.jpg); background-position: center; background-repeat: no-repeat;background-size: cover;background-attachment:fixed;">
	
	<h1 class="toptitle"><i class="fa fa-file-text roundiconad"></i>
			</h1>
	<div class="container">
		<div class="textwidget">						
			<div class="contactstyle topform">										
				<form method="post" action="registrarad.php">
				<br><h1 align="center">FORMULARIO DE INTERES ADMINISTRACIÓN</h1>
    	   ...
    	   <input  type="submit" name="register"  value="ENVIAR" style="background:#059788; border:none; color:white;" onclick="return entrada()">
           </form>
			</div>	
...
<section id="about" class="whitetext" style="padding:60px;background-color:#059788;" >
