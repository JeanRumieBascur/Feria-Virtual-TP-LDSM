...
<!-- FIN DE JAVASCRIPT -->
<body>
<section id="home" style="padding:110px 0;background-image: url(imag/DSCF0720.jpg); background-position: center; background-repeat: no-repeat;background-size: cover;background-attachment:fixed;">
	
	<h1 class="toptitle"><i class="fa fa-file-text roundiconop"></i>
			</h1>
	<div class="container">
		<div class="textwidget">						
			<div class="contactstyle topform">										
				<form method="post" action="registrarop.php">
				<br><h1 align="center">FORMULARIO DE INTERES OPERACIÓNES PORTUARIAS</h1>
    	   ...
    	   <input  type="submit" name="register"  value="ENVIAR" style="background:#a5a919; border:none; color:white;" onclick="return entrada()">
           </form>
			</div>	
...
<section id="about" class="whitetext" style="padding:60px;background-color:#a5a919;" >
